...
tempf = (temp_live['temp']-273.15)*9/5+32
t10 = (data_soil['t10']-273.15)*9/5+32
t0 = (data_soil['t0']-273.15)*9/5+32
ms = data_soil['moisture']



try:
	ffdb = 'INSERT INTO prueba(finca_ID,Date,temp,uvi,t10,moisture,t0) VALUES(1,%s,%s,%s,%s,%s,%s)'
	vals = [dt,tempf,uvi,t10,ms,t0]
